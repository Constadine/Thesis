...
class BirdClimateDataProcessor:
    """
    Orchestrates the processing of bird and climate data from raw files to paired dataset.
    """

    def __init__(self, config: Config, logger: Optional[logging.Logger] = None):
        self.config = config
        self.logger = logger or setup_logger('BirdClimateDataProcessor', self.config.log_file)
