...
if __name__ == '__main__':
    ...
    pairs_dict = {}  # Dictionary to store pairs DataFrames for each climate variable
    ...
    for climate_folder, climate_variables in climate_folders.items():
        for climate_variable in climate_variables:
            ...
            # Assign the concatenated DataFrame to a variable with the variable name
            globals()[climate_variable] = result_df
            ...
            merged_data_extremes = pd.merge(df_extremes, pairs_dict[climate_variable], left_on='Station', right_on='obs_file', how='inner')
            merged_data_normals = pd.merge(df_normal, pairs_dict[climate_variable], left_on='Station', right_on='obs_file', how='inner')
